...
printf ">s1\nACG\n>s2\nAG\n>s3\nA\n" | \
    "${VSEARCH}" \
        ...
        --output - | \
    tr "\n" "@" | \
    grep -qx ">s2;size=2@AG@>s1;size=1@ACG@" && \
    success "${DESCRIPTION}" || \
        failure "${DESCRIPTION}"
...
printf ">s1\nAG\n>s2\nACG\n>s3\nA\n" | \
    "${VSEARCH}" \
        ...
        --output - | \
    tr "\n" "@" | \
    grep -qx ">s1;size=2@AG@>s2;size=1@ACG@" && \
    success "${DESCRIPTION}" || \
        failure "${DESCRIPTION}"
...
printf ">s1;size=2\nAC\n>s2;size=1\nAG\n>s3;size=1\nA\n" | \
    "${VSEARCH}" \
        ...
        --output - | \
    tr "\n" "@" | \
    grep -qx ">s1;size=3@AC@>s2;size=1@AG@" && \
    success "${DESCRIPTION}" || \
	failure "${DESCRIPTION}"
...
printf ">s1;size=1\nAC\n>s2;size=2\nAG\n>s3;size=1\nA\n" | \
    "${VSEARCH}" \
        ...
        --output - | \
    tr "\n" "@" | \
    grep -qx ">s2;size=3@AG@>s1;size=1@AC@" && \
    success "${DESCRIPTION}" || \
	failure "${DESCRIPTION}"
...
printf ">s1\nAC\n>s2\nAG\n>s3\nA\n" | \
    "${VSEARCH}" \
        ...
        --output - | \
    tr "\n" "@" | \
    grep -qx ">s1;size=2@AC@>s2;size=1@AG@" && \
    success "${DESCRIPTION}" || \
	failure "${DESCRIPTION}"
...
printf ">s2\nAC\n>s1\nAG\n>s3\nA\n" | \
    "${VSEARCH}" \
        ...
        --output - | \
    tr "\n" "@" | \
    grep -qx ">s1;size=2@AG@>s2;size=1@AC@" && \
    success "${DESCRIPTION}" || \
	failure "${DESCRIPTION}"
...
printf ">s\nAC\n>s\nAG\n>s3\nA\n" | \
    "${VSEARCH}" \
        ...
        --output - | \
    tr "\n" "@" | \
    grep -qx ">s;size=2@AC@>s;size=1@AG@" && \
    success "${DESCRIPTION}" || \
	failure "${DESCRIPTION}"
...
printf ">s\nAG\n>s\nAC\n>s3\nA\n" | \
    "${VSEARCH}" \
        ...
        --output - | \
    tr "\n" "@" | \
    grep -qx ">s;size=2@AG@>s;size=1@AC@" && \
    success "${DESCRIPTION}" || \
	failure "${DESCRIPTION}"
...
DESCRIPTION="--derep_prefix outputs a median cluster size"
printf ">s1\nA\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
DESCRIPTION="--derep_prefix median (empty entry, no median)"
printf "" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
DESCRIPTION="--derep_prefix median (single entry, median = 1)"
printf ">s1\nA\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
DESCRIPTION="--derep_prefix median (single entry with size annotation, median = 2)"
printf ">s1;size=2\nA\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
DESCRIPTION="--derep_prefix median (two entries, median = 1)"
printf ">s1\nA\n>s2\nC\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
DESCRIPTION="--derep_prefix median (two entries with equal size annotations, median = 2)"
printf ">s1;size=2\nA\n>s2;size=2\nC\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
DESCRIPTION="--derep_prefix median (1 + 2 -> median = 2)"
printf ">s1;size=1\nA\n>s2;size=2\nC\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
DESCRIPTION="--derep_prefix median (1 + 3 -> median = 2)"
printf ">s1;size=1\nA\n>s2;size=3\nC\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
DESCRIPTION="--derep_prefix median (1 + 4 -> median = 2)"
printf ">s1;size=1\nA\n>s2;size=4\nC\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
DESCRIPTION="--derep_prefix median (1 + 5 -> median = 3)"
printf ">s1;size=1\nA\n>s2;size=5\nC\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
DESCRIPTION="--derep_prefix median (1 + 6 -> median = 4)"
printf ">s1;size=1\nA\n>s2;size=6\nC\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
DESCRIPTION="--derep_prefix median (1 + 7 -> median = 4)"
printf ">s1;size=1\nA\n>s2;size=7\nC\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
DESCRIPTION="--derep_prefix median (1 + 8 -> median = 4)"
printf ">s1;size=1\nA\n>s2;size=8\nC\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
DESCRIPTION="--derep_prefix median (1 + 9 -> median = 5)"
printf ">s1;size=1\nA\n>s2;size=9\nC\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
DESCRIPTION="--derep_prefix --minseqlength larger than --maxseqlength triggers a warning"
printf ">s\nAA\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 2 \
...
DESCRIPTION="--derep_prefix --minseqlength smaller than --maxseqlength triggers no warning"
printf ">s\nAA\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
"${VSEARCH}" \
    --derep_prefix "${AT_DIR}/sampleA_R1.fasta" \
    --minseqlength 1 \
    --quiet \
    --relabel @ \
    --output /dev/null 2> /dev/null && \
...
DESCRIPTION="--derep_prefix --relabel @ renames after the input file"
AT_DIR=$(mktemp -d)
printf ">s\nA\n" > "${AT_DIR}/sampleA_R1.fasta"
"${VSEARCH}" \
    --derep_prefix "${AT_DIR}/sampleA_R1.fasta" \
...
DESCRIPTION="--derep_prefix --relabel no size annotations (size annotation in, without --sizeout)"
printf ">s;size=2\nA\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
DESCRIPTION="--derep_prefix --relabel_self no size annotations (size annotation in, without --sizeout)"
printf ">s;size=2\nA\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
DESCRIPTION="--derep_prefix --relabel_md5 no size annotations (size annotation in, without --sizeout)"
printf ">s;size=2\nA\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
...
DESCRIPTION="--derep_prefix --relabel_sha1 no size annotations (size annotation in, without --sizeout)"
printf ">s;size=2\nA\n" | \
    "${VSEARCH}" \
        --derep_prefix - \
        --minseqlength 1 \
